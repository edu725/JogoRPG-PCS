class Attribute:
    ...
    def definition_charisma(self,charisma):
        ...
        if charisma ==0:
            return f"Nível de Carisma iguil a {charisma}: Aberração:"
        elif charisma >=1 and charisma <=5:
            return f"Nível de Carisma iguil a {charisma}: Inexprecivo"
        elif charisma >=6 and charisma <=9:
            return f"Nível de Carisma iguil a {charisma}: Rude"
        elif charisma >=10 and charisma <=11:
            return f"Nível de Carisma iguil a {charisma}: Socíavel"
        elif charisma >=12 and charisma <=15:
            return f"Nível de Carisma iguil a {charisma}: Persuasivo"
        elif charisma >=16 and charisma <=20:
            return f"Nível de Carisma iguil a {charisma}: Influente"
        else:
            return f"Nível de Carisma iguil a {charisma}: Ídolo"